...
namespace Langue.ProjectAnalyzers
{
    public static class Diagnostics
    {
        ...
        public static readonly DiagnosticDescriptor LicenseFileHeader = new DiagnosticDescriptor(
            id: "LPA0001",
            title: "License file header required.",
            messageFormat: "Missing license header",
            category: "Style",
