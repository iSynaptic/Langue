...
namespace Langue
{
    public static class Xml
    {
        ...
        public static Pattern<string, XElement> Attribute(string xpath, string name) => ctx =>
        {
        ...
        public static Pattern<IEnumerable<string>, XElement> Attributes(string name) => ctx =>
        {
        ...
        public static Pattern<IEnumerable<String>, XElement> Attributes(string xpath, string name) => ctx =>
        {
        ...
        public static Pattern<String, XElement> Content(string xpath) => ctx =>
        {
            var el = ctx.XPathSelectElement(xpath);
            return el != null
        ...
        public static Pattern<IEnumerable<String>, XElement> Contents(string xpath) => ctx =>
        {
            var els = ctx.XPathSelectElements(xpath);
            return Match.Success(els.Select(x => x.Value).ToArray(), ctx, "");
        };

        public static Pattern<T, XElement> Element<T>(string xpath, Pattern<T, XElement> body) => ctx =>
        {
            var el = ctx.XPathSelectElement(xpath);
            if (el == null)
        ...
        public static Pattern<IEnumerable<T>, XElement> Elements<T>(string xpath, Pattern<T, XElement> body) => ctx =>
        {
            var els = ctx.XPathSelectElements(xpath);
